...
<html lang="nl">
    <head>
        ...
        <meta name="description" content="Ocean Studios.">
        <meta name="keywords" content="ocean studios, ocean studio, oceanstudios, oceanstudio, ocean, studio, studios">
        <meta name="author" content="Ocean Studios">

        <link rel="apple-touch-icon" sizes="152x152" href="/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">
        <link rel="manifest" href="/site.webmanifest">
        <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#219a94">
        <meta name="msapplication-TileColor" content="#219a94">
    ...
    <body>
        ...
        <footer class="footer">
            ...
            <div class="contact">
                <h2 class="contact__h2"><i><b>Contact</i></b></h2>
                <a class="contact__tel" href="tel:+31 020 850 9500">Tel: +31 020 850 9500</a>
                <h3 class="contact__times">Maandag - Vrijdag: 09:00 - 17:00</h3>
                <h3 class="contact__loc">Contactweg 36, 1014 AN, Amsterdam</h3>
                <a class="contact__mail" href="mailto:info@oceanstudios.nl">info@oceanstudios.nl</a>
            </div>
            <div class="service"> 
                <h2 class="service__h2">Service</h2>
                <a class="service__a" href="#Klantenservice">Klantenservice</a>
                <a class="service__a" href="#Help">Help</a>
            </div>
        </footer>
